    ...
    <>
      ...
      <div className="App_page_container">
        ...
        <div className="sound_cloud_filter_wrapper" id="myHeader">
          <div className="hide_by_feature">
            {color == 1 ? "" : <UiSecreenFilter />}{" "}
          </div>
          <div className="filter_content_wrapper">
            <div
              className={color === 1 ? "filter_active ui_vedio" : "ui_vedio"}
            ...
            <div
              className={color === 2 ? "filter_active ui_vedio" : "ui_vedio"}
              onClick={() => chnageTabData2(2)}
            >
              <div>
                <img src={secreen} />
              </div>
