...
const SignUp = () => {
  ...
  return (
    <>
    { showModal && <Container className="signup_container" fluid>
        <div className="close_img_outer">
          <Image onClick={handelModal} className="close_img" src={close} rounded />
        </div>
   ...
   {showModal ===false &&   <button onClick={handelModal} className="my-5 mx-5">SignUp</button>}
    </>
  );
};
